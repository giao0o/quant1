...
# 获取中证2000数据
hs300_data = ak.index_zh_a_hist(symbol='932000', period='daily', start_date='20200101', end_date='20241231')
...
# 提取必要数据
dates = hs300_data.index
strategy = hs300_data['change_pct']
...
# 测试不同的 sig 值
sig_values = sig_values = np.arange(0, 1, 0.1).tolist()
yearly_results = {}
